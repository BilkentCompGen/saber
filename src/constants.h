...
// The default minimum block size for the alignment. Currently set to 16
#define DEFAULT_L_MIN 16
// The default maximum block size for the alignment. Currently set to 32.
#define DEFAULT_L_MAX 32
// The default maximum number of iterations for the alignment algorithm. Currently set to 4.
#define DEFAULT_MAX_ITERATIONS 3
// The default maximum error rate for the algorithm. Currently set to 0.15.
